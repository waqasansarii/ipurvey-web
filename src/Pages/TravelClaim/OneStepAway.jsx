    ...
    <div className="steper_form_container">
      <div className="stepper_form_md">
        <div className="stepper_form">
          <h2 style={{fontSize:'1.15rem'}}>You're one step away from your claim!</h2>
          ...
          <div className="accept_privacy">
            ...
            <p>
              We have updated our <Link to="" className='stp_link'> Terms of Service </Link>,{' '}
              <Link to="" className='stp_link'>Privacy Policy </Link>, and{' '}
              <Link to='' className='stp_link'> Cookie Policy </Link>. By accepting, you agree to our
              updated <Link to="" className='stp_link2'> terms and policies.</Link>
            </p>
          </div>
          <div className="stp_btns">
            ...
            <button className="stp_back">Already a member?<Link to='/login' className='stp_link'> Login </Link></button>
          </div>
        </div>
      </div>
    </div>
